...
@Component({
	selector: 'app-official-action',
	imports: [ActionsMenuComponent],
	templateUrl: './official-action.component.html',
	styleUrl: './official-action.component.scss',
})
export class OfficialActionComponent extends BaseActionsComponent<any> {
