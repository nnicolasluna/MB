...
@Component({
    selector: 'app-map-data-actions',
    imports: [ActionsMenuComponent, ButtonModule, TooltipModule, MenuModule],
    templateUrl: './map-data-actions.component.html',
    styleUrl: './map-data-actions.component.scss',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class MapDataActionsComponent extends BaseActionsComponent<MapData> {
	override resource: ResourceTypes = ResourceTypes.CARTOGRAPHIC_RESOURCES;
