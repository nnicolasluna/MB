...
@Component({
    selector: 'app-styles-actions',
    imports: [ActionsMenuComponent, ButtonModule, TooltipModule, MenuModule],
    templateUrl: './styles-actions.component.html',
    styleUrl: './styles-actions.component.scss',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class StylesActionsComponent extends BaseActionsComponent<Style> {
	override resource: ResourceTypes = ResourceTypes.CARTOGRAPHIC_STYLES;
