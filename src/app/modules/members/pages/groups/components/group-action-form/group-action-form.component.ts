...
@Component({
	selector: 'app-group-action-form',
	imports: [ActionsMenuComponent],
	templateUrl: './group-action-form.component.html',
	styleUrl: './group-action-form.component.scss',
})
export class GroupActionFormComponent extends BaseActionsComponent<any> {
