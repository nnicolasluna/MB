...
import { MonitoringUse } from '../interfaces/monitoring-use/monitoring-use.interface';

@Injectable({
	providedIn: 'root',
})
export class MonitoringUseService extends BaseCRUDHttpService<MonitoringUse> {
	constructor() {
		super('monitoring-use');
	}

	public download(map: MonitoringUse) {
