...
import { SoilAlert } from '../interfaces/soil-alert/soil-alert.interface';

@Injectable({
	providedIn: 'root',
})
export class SoilAlertService extends BaseCRUDHttpService<SoilAlert> {
	constructor() {
		super('soil-alerts');
	}

	public download(map: SoilAlert) {
