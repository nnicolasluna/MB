...
import { MonitoringBurn } from '../interfaces/monitoring-burn/monitoring-burn.interface';

@Injectable({
	providedIn: 'root',
})
export class MonitoringBurnService extends BaseCRUDHttpService<MonitoringBurn> {
	constructor() {
		super('monitoring-burn');
	}

	public download(map: MonitoringBurn) {
