...
@Component({
	selector: 'app-burn-historic-actions',
	imports: [ActionsMenuComponent, ButtonModule, TooltipModule, MenuModule],
	templateUrl: './burn-historic-actions.component.html',
	styleUrl: './burn-historic-actions.component.scss',
	changeDetection: ChangeDetectionStrategy.OnPush,
})
export class BurnHistoricActionsComponent extends BaseActionsComponent<MapData> {
