...
@Component({
	selector: 'app-monitoring-water-form',
	imports: [
		FormsModule,
		ReactiveFormsModule,
		LoaderComponent,
	...
	templateUrl: './monitoring-water-form.component.html',
	styleUrl: './monitoring-water-form.component.scss',
	changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MonitoringWaterFormComponent extends BaseFormComponent<MonitoringWater> {
	...
	override _service = inject(MonitoringWaterService);
