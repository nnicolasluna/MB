...
@Component({
	selector: 'app-monitoring-water-actions',
	imports: [ActionsMenuComponent, ButtonModule, TooltipModule, MenuModule],
	templateUrl: './monitoring-water-actions.component.html',
	styleUrl: './monitoring-water-actions.component.scss',
	changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MonitoringWaterActionsComponent extends BaseActionsComponent<MapData> {
