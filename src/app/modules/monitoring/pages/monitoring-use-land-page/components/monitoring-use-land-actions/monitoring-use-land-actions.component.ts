...
@Component({
	selector: 'app-monitoring-use-land-actions',
	imports: [ActionsMenuComponent, ButtonModule, TooltipModule, MenuModule],
	templateUrl: './monitoring-use-land-actions.component.html',
	styleUrl: './monitoring-use-land-actions.component.scss',
	changeDetection: ChangeDetectionStrategy.OnPush,
})
export class MonitoringUseLandActionsComponent extends BaseActionsComponent<MonitoringUse> {
